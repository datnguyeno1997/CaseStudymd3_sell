...
<section class="checkout spad">
    <div class="container">
        <div class="checkout__form">
            ...
            <form method="post" action="/billdetail">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="checkout__input">
                                    <p>Name<span>*</span></p>
                                    <input name="name" class="name" type="text" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="checkout__input">
                            <p>Address<span>*</span></p>
                            <input class="Address" name="address" type="text" placeholder="Street Address" required="required">
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="checkout__input">
                                    <p>Phone<span>*</span></p>
                                    <input  name="phone" class="Phone" type="text" required="required">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="checkout__input">
                                    <p>Email<span>*</span></p>
                                    <input name="email" class="Email" type="text" required="required">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="checkout__order">
                            ...
                            <c:forEach items="${requestScope.cart.getCartItems()}" var="cartItem">
                                <ul>
                                    <li>${cartItem.product.name}<span>${cartItem.price * cartItem.quantity}</span></li>
