            ...
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    ...
                    <div class="breadcrumb__option">
                        ...
                        <a style="color: black" href="/homes">Vegetables</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img style="height: 400px !important;" src="${p.getAvatar()}"
                             alt="">

                    </div>
                    <div class="product__details__pic__slider owl-carousel">
                        <img data-imgbigurl="/dashboard/img/product/details/product-details-2.jpg"
                             src="/dashboard/img/product/details/thumb-1.jpg" alt="">
                        <img data-imgbigurl="/dashboard/img/product/details/product-details-3.jpg"
                             src="/dashboard/img/product/details/thumb-2.jpg" alt="">
                        <img data-imgbigurl="/dashboard/img/product/details/product-details-5.jpg"
                             src="/dashboard/img/product/details/thumb-3.jpg" alt="">
                        <img data-imgbigurl="/dashboard/img/product/details/product-details-4.jpg"
                             src="/dashboard/img/product/details/thumb-4.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="/dashboard/img/product/product-1.jpg">
